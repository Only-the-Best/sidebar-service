                    ...
                    {/* <div className='sig-content'> */}
                        <div className='sig-photo'>
                            <div className='sig-photo-container'>
                                ...
                                <img className='agent-pic' src='https://photos.zillowstatic.com/h_n/ISxz503n09msss0000000000.jpg'></img>
                                </label>
                            </div>
                        </div>
                        <div className='sig-info'>
                            <div className='display-name'>
                                <a href='#' className='profile-link'>
                                    <span className='name'>JEAN NI</span>
                                </a>
                            </div>
                            <span className='display-rating'>
                                ...
                                <span className='count-rating'>
                                    (<a href='#' className='ratings-num'>2</a>)
                                </span>
                            </span>
                            <span className='recent-sales'>
                                <a href='#' className='profile-link'>
                                    <span className='sales-count'>0</span>
                                    <span className='sales-text'>Recent sales</span>
                                </a>
                            </span>
                            <span className='phone-num'>(626) 487-0432</span>
                        </div>                           
